...
export default function Landing({ images, categories, events, eventsTickets, setEventsTickets, imagesLoading }) {
  ...
  return (
    <Container className="mt-3">
      <Row>    
        <Col sm={6}><Image className="mt-5"   style={{maxWidth:"600px", border: "1px solid #429DD0", borderRadius: "15px", borderTopLeftRadius:"0px" ,height:'auto', width:'100%'}} src={images?.landing?.full} alt="cafe picture"/> {imagesLoading  && <p>-- Image Loading --</p>}  </Col>
