            ...
            : eventTickets && event && (
                <Row className=''> 
                    ...
                    <Col>
                        ...
                        {currentUser && !alreadySignedUp ? <><Button className="ms-5" onClick={handleShow}>Sign Up</Button><SignUpModal setShow={setShow} show={show} event={event}/>   </> : null}
                    </Col>
                </Row>
            )
        }
